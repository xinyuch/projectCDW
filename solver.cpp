...
//----------------------------------------------------------------------
 ...
 void solver ( vector<string> &start, vector<char> &output) {
 ...
 //vector<string> start = { "RU", "LF", "UB", "DR", "DL", "BL", "UL", "FU", "BD", "RF", "BR", "FD", "LDF", "LBD", "FUL", "RFD", "UFR", "RDB", "UBL", "RBU" };
...
//            temp = ((char)("UDFBLR"[algorithm[i]/3])) + ((char)(algorithm[i]%3+1));
//            
//            cout << temp;
            output.push_back(((char)("UDFBLR"[algorithm[i]/3])));
            output.push_back((algorithm[i]%3+1+'0'));
	    }
